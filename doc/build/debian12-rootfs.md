...
[./doc/build/linux-kernel-6.1.70.md](linux-kernel-6.1.70.md)
...
shell$ sudo cp debian/linux-image-6.1.70-armv7-fpga_6.1.70-armv7-fpga-1_armhf.deb $PWD/$targetdir
```
...
debian12-rootfs# dpkg -i linux-image-6.1.70-armv7-fpga_6.1.70-armv7-fpga-1_armhf.deb
```
...
shell$ sudo rm -f  $PWD/$targetdir/linux-image-6.1.70-armv7-fpga_6.1.70-armv7-fpga-1_armhf.deb
